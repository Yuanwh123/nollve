...
<html>
	<head>
		...
		<script type="text/javascript" src="../js/back1.js"></script>
	</head>
	<body>
    ...
    <div class="BackTop">
        <span>您的位置：</span>
        <a href="../first/index">首页</a>
        <a href="../second/mine"> 我的</a>
        <a href="../second/bought"> 已买到的宝贝</a>
        <a href="#"> 退款</a>
    </div>
    <div class="BackCon" >
    <!-- 
       <div>
           <div class="bacPic"><img src="../img/bacPic_03.png"></div><span>日本NOVELLA那绯澜无硅油氨基酸滋润保湿洗发水550ml</span>
       </div>
       <div>
           <p>选择服务类型</p>
           <div class="bac">
               <img src="../img/thtk_03.png"><span><a href="step2">退货退款</a></span>
           </div>
       </div>
       -->
    </div>
				...
				<div class="footList clearfix">
					<div class="listLeft clearfix fl">
						<ul>
							...
							<ul>
								<a href="../frist/mall"><li class="footer_firstLi">洗发水</li></a>
								<a href="../frist/mall"><li>沐浴露</li></a>
								<a href="../frist/mall"><li>精油</li></a>
								<a href="../frist/mall"><li>洗面奶</li></a>
							</ul>
							</li>
